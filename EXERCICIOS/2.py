...
df['genero'].value_counts()           # Minha previsão: Quantidades de um valor específico na coluna 'genero'.
...
df[['jogo', 'ano']].tail(3)            # Minha previsão: Valores das colunas 'jogo' e 'ano' das últimas 3 linhas.
df.describe().loc['mean']              # Minha previsão: Média de todas as colunas numéricas do DataFrame.
